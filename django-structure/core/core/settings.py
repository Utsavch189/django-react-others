...
SECRET_KEY = 'django-insecure-#za&4(3)jr(4uk@barc!(%&^axebl$-oqo1!k!@+5i^pt&858^'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'core.rest_exception_handler.exception_handler.custom_exception_handler',
